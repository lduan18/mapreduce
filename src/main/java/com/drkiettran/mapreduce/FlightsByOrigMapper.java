 ...
 */
public class FlightsByOrigMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    private static final Logger LOGGER = LoggerFactory.getLogger(FlightsByOrigMapper.class);
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (key.get() > 0) {
            ...
            Text uniqueCarrier = new Text(lines[16]);
