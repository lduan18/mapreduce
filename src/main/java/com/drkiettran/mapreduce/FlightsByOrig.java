...
public class FlightsByOrig {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        job.setJarByClass(FlightsByOrig.class);
        job.setJobName("FlightsByOrig");

        TextInputFormat.addInputPath(job, new Path(inputPath));
        job.setInputFormatClass(TextInputFormat.class);

        job.setMapperClass(FlightsByOrigMapper.class);
        job.setReducerClass(FlightsByOrigReducer.class);
